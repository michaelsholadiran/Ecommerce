                                        ...
                                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: center;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                      ...
                                                      @if ($text_logo)
                                                                ...
                                                                <img src="{{request()->root() . '/assets/frontend/images/'.$text_logo}}" alt="{{$name}} Logo" title="{{$name}}" /></a>
                              													@endif
                                                    </td>
                                                </tr>
                                                {{-- <tr>
                                                ...
                                                <tr>
                                                  ...
                                                  @endphp
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                         Customer Service: {{$customer_support[0]}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 25px;">
                                                        <strong>Order Number:</strong> {{$order->id}} | <strong>Order Date:</strong> {{$order->created_at->format('d-M-Y')}}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td rowspan="4" style="padding-right: 10px; padding-bottom: 10px;">
                                                        <img style="height: 80px;" src="{{$o->image}}" alt="Product Image" />
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 14px; line-height: 18px; color: #757575; text-align: right; padding-bottom: 10px;">
                                                        <b style="color: #666666;">${{$o->price}}</b> Total
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" style="font-size: 16px; font-weight: bold; color: #666666; padding-bottom: 5px;">
                                                        Payment Method (Powered By Paypal)
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="width: 100%; text-align: center; font-style: italic; font-size: 13px; font-weight: 600; color: #666666; padding: 15px 0; border-top: 1px solid #eeeeee;">
                                                        <b style="font-size: 14px;">Thank you for your order</b>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
