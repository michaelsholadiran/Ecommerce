...
@section('content')
@php $page='products'; $title="Edit Product";
@endphp
<!-- Main Content -->
<div class="main-content">
    <section class="section">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body d-flex justify-content-between">
                    <h4><i data-feather="edit-2"></i> Edit Product</h4>
        ...
        <div class="col-12">
                ...
                <form action="{{route('backend.product.update',['id'=>$product->id])}}" class="ajaxForm form-validate update" id="myform" name="myform" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
               ...
               <div class="col-12">
                 <div class="card">
                   ...
                   <div class="card-body">
                         ...
                         <input name="files[]" type="file" multiple class="form-control ignore" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control"  placeholder="0.00" name="price" id="price"  value="{{$product->price}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="compare_price">Compare Price</label>
                                <input type="text" class="form-control" id="compare_price" placeholder="0.00" name="compare_price"  value="{{$product->compare_price}}">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" id="quantity" placeholder="0.00" name="quantity"  value="{{$product->quantity}}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="weight">Weight</label>
                                <input type="number" class="form-control" id="weight" placeholder="0.00" name="weight"  value="{{$product->weight}}">
                            </div>
                        </div>
...
max-width: 600px;
 	...
 	<h1> Title & Description Tool </h1>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="title">Title:</label>
                                    <textarea class="form-control" rows="1" placeholder="Type your title" id="seo_title"  name="seo_title"> {{$product->seo_title}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" placeholder="Input your description" id="seo_description"  name="seo_description">{{$product->seo_description}}</textarea>
                            ...
                            <div class="preview">
                              ...
                              @endphp
                                <span id="titlePreview">{{$product->seo_title}}</span><span class="title-preview">| {{$name}}</span>
                                <br>
                                <span id="URL">{{request()->root()}}/<span id="urlPreview">{{$product->url_slug}}</span></span>
                                <br>
                                <span id="descPreview">{{$product->seo_description}}</span>
                            </div>
